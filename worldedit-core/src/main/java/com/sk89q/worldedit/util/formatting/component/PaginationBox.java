...
public abstract class PaginationBox extends MessageBox {
    ...
    public Component create(int page) throws InvalidComponentException {
        ...
        getContents().newline();
        TextComponent pageNumberComponent = TextComponent.of("Страница ", TextColor.WHITE)
                .append(TextComponent.of(String.valueOf(page), TextColor.GOLD))
                .append(TextComponent.of(" из ", TextColor.WHITE))
        ...
        if (pageCommand != null) {
            ...
            if (page > 1) {
                TextComponent prevComponent = TextComponent.of("<<< ", TextColor.GOLD)
                        ...
                        .hoverEvent(HoverEvent.of(HoverEvent.Action.SHOW_TEXT, TextComponent.of("Нажмите, чтобы листать")));
